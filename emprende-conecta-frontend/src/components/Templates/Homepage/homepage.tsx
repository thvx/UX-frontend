        ...
        <div className="flex flex-col justify-center w-full p-12">
            <div className="flex flex-col w-full lg:flex-row justify-center content-center px-8 mb-12">
                <aside className="text-container content-center">
                    ...
                    <h1 className="text-3xl font-bold text-center text-custom-yellow mb-8">
                        Vende a todo el Perú
                    </h1>
                    <p className="text-xl text-white p-2">
                        Sin comisiones. Digitaliza tu MYPE
                    </p>
                    <p className="text-xl text-white p-2 pb-8">
            ...
            <div className="flex flex-col flex-wrap sm:gap-12 lg:flex-row mx-64 justify-around mb-12">
                <div className="category">
                    <Avatar
                        ...
                        size="w-32"
                    />
                    <p className="p-2 text-center rounded-lg bg-custom-darkblue text-white text-bold">
                        Salud
                    </p>
                </div>
                <div className="category">
            ...
            <div className="mb-24">
                ...
                <h2 className="text-3xl font-bold text-center text-white mb-8">
                    #Emprende&Conecta
                    <div className="border-t-2 border-white mt-2 mx-auto w-32"></div>
                </h2>
                <div className="flex row gap-24 justify-center mb-12">
                    <p className="text-xl font-bold text-custom-yellow">ALL</p>
                    <p className="text-xl font-bold text-white">DEPORTE</p>
                    <p className="text-xl font-bold text-white">COMIDAS</p>
                </div>
            </div>
